    ...
    <section className="about-section">
      ...
      <div className="about-content">
        ...
        <div className="img-text">
          <p>
            Nuestra misión es transformar cada viaje en una experiencia
            inolvidable, combinando comodidad, autenticidad y atención al
            detalle para que encuentre un espacio de descanso especial mientras
            explora nuevos lugares.
          </p>
          <img
            src="/images/alojamiento2.webp"
