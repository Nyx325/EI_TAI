...
type ReservaWithForeignData = Prisma.ReservaGetPayload<{
  include: { Cliente: true; Alojamiento: true };
}>;

// Hacer solo las relaciones opcionales
type PrismaReserva = Omit<ReservaWithForeignData, "Cliente" | "Alojamiento"> &
  Partial<{
